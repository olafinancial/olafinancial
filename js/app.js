...
const WPApp = (() => {
  ...
  const NAV_ITEMS = [
    ...
    { path: '/budget',         icon: '&#x1F4CA;', label: 'Budget Planner',   section: 'Planning' },
    { path: '/balance-sheet',  icon: '&#x2696;',  label: 'Balance Sheet',  section: 'Planning' },
    { path: '/assets',         icon: '&#x1F4C8;', label: 'Assets',         section: 'Planning' },
    { path: '/liabilities',    icon: '&#x1F4C9;', label: 'Liabilities',    section: 'Planning' },
